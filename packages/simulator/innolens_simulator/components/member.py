...
def rand_department() -> str:
  return rand_element(_departments)


_types_of_study: Sequence[str] = (
  'Undergraduate',
  'Taught Postgraduate',
...
def rand_year_of_study() -> int:
  return rand_element(_years_of_study)


_affiliated_student_interest_groups: Sequence[str] = (
  'GGCS 2019 Global Grand Challenge Summit Hong Kong team (Supervisor: Dr. Hayden So [EEE])',
  'The Greater Bay Area drone competition - Team GG2EZ (Supervisor: Dr. Fu Zhang [ME])',
  'Robomaster 2019-20 competition Team HeraKles (Supervisor: Dr. Kenneth Wong [CS])',
  'Smart Water Auditing (Supervisor: Dr. K.S. Lui [EEE])',
  'Robotic fish - The Vayu project (Supervisor: Dr. Wang, Zheng [ME])',
  'Robocon (Supervisor: Dr. K.W. Kwok [ME])',
  'Project InnoLens and InnoIris (Supervisor: Dr. C.K. Chui [CS])',
  'Project Seismic performance of precast segmental (Supervisor: Prof. T.K. Au [Civil])',
  'Smart Parking System (Supervisor: Dr. K.S. Lui [EEE])',
  '3D Holographic Imaging System (Supervisor: Dr. Michael Chau [FBE (IS)])',
  'ICRA AI Challenge Team (Supervisor: Dr. Pan Jia [CS])',
  'HKU Racing 2020 (Supervisor: Dr. C.K. Lee [EEE])'
)

def rand_affiliated_student_interest_group() -> str:
